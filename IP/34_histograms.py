...
hist = cv2.calcHist([img], [0], None, [256], [0, 256])#y axis shows pixels and x axis shows colors
plt.plot(hist)
plt.show()
cv2.imshow("res",img)
cv2.waitKey(0)
...
plt.hist(b.ravel(), 256, [0, 256])#last argument is range and second is hist size
