...
import pafy      #open cmd prompt and type pip install pafy
import cv2
import numpy as np
...
output = cv2.VideoWriter("output1.mp4",fourcc,20.0,(640,480),0)
while(cap.isOpened()):
    ...
    if ret==True:
        ...
        f = np.array(frame) #convert image into array
