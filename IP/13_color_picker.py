...
switch = '0 : OFF \n1 : ON'
cv2.createTrackbar(switch, 'Color Picker',0,1,cross)#Here this cross function made for if no value chosen then this function will execute
...
while True:#Here infinite loop coz we want to pick color many times
    ...
    if s==0:
        img[:] = 0#It means that array's all pixels are 0
    else:
