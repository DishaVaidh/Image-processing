...
img = cv2.imread("one.jpg")#Data\\thor.jpg
img = cv2.resize(img,(600,700))

#Creating Blank Image---

#Here 1n array first dimension represent width,second height and third channels
...
img = cv2.circle(img, (447, 125), 63, (214, 255, 0), -5)#if we pass -ve thickness it fill the shape

font = cv2.FONT_ITALIC
#puttext -accept(img,text,start_co,font,fontsize,color,thickness,linetype)
img = cv2.putText(img, 'Black', (20, 500), font, 4, (0, 125, 255), 10,cv2.LINE_AA)

#ellipse-accept(img,start_cor,(length,height),rotation in x,rotation in y,color,thickness)
