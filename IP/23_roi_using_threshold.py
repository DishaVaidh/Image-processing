...
# Load two images
img1 = cv2.imread("roi1.png")
img2 = cv2.imread("roi2.png")
img3=img1


img1 = cv2.resize(img1,(1024,650))
img2 = cv2.resize(img2,(600,650))#this size must be less than img1 coz we want to add this image in img1
