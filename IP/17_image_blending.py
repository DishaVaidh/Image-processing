...
result = img2+img1  #numpy addition in this we get module between value(some pixels destroy)
...
#function cv2.addWeighted(img1,wt1,img2,wt2,gama_val),gama value for saturation
